      ...
      <div className="container relative z-10 mx-auto px-4 md:px-6 py-32">
        <div className="max-w-2xl">
          ...
          <motion.p
            ...
            className="text-label text-gold-light mb-6 tracking-[0.3em]"
          >
            Timeless Elegance
          </motion.p>
          ...
          <motion.h1
            ...
            className="font-display text-5xl md:text-6xl lg:text-7xl font-light text-foreground mb-2 leading-[1.1]"
          >
            Antique Jewelry
          </motion.h1>
          ...
          <motion.h1
            ...
            className="font-display text-5xl md:text-6xl lg:text-7xl font-light italic text-gold mb-8 leading-[1.1]"
          >
            Reimagined
          </motion.h1>
          ...
          >
            Discover our curated collection of exquisite antique-inspired pieces, 
          ...
          >
            <button
              ...
              className="btn-gold rounded-full inline-flex items-center gap-3 group"
            >
